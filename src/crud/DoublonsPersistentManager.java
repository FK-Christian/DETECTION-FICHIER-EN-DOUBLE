...
public class DoublonsPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Doublons";
	...
	private DoublonsPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new DoublonsPersistentManager();
		}
